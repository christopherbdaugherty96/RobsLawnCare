# ShortCut Lawn Care - $5,000 Startup Plan

This document captures the practical launch plan for starting ShortCut Lawn Care with a pickup truck and an estimated $5,000 startup budget.

The goal is to start lean, avoid debt, focus on recurring residential lawn care, and add pressure washing as a profitable upsell instead of trying to launch as a full-scale equipment-heavy company on day one.
